...
public class IndexNestedJoinEvaluator extends RAEvaluator {

	public IndexNestedJoinEvaluator(DB db, Operation op,
			BoundedConcurrentLinkedQueue output) {
		super(db, op, output);
		// TODO Auto-generated constructor stub
		this.opj = (IndexNestedLoopJoin) op;
	}
	...
	private IndexNestedLoopJoin opj = null;
	...
	public void run() {
		...
		if (GlobalConfiguration.debug) {
			System.out.println("Nested loop join on: " + tblName + " " + join_key);
		}
