...
public class IndexFilterJoinEvaluator extends RAEvaluator {
	public IndexFilterJoinEvaluator(DB db, Operation op,
			BoundedConcurrentLinkedQueue output) {
		super(db, op, output);
		// TODO Auto-generated constructor stub
		this.opj = (IndexFilterJoin) op;
	}
	...
	private IndexFilterJoin opj = null;
